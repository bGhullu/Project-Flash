...
const factoryABIs = {
    uniswapV2: [ /* ABI for Uniswap V2 Factory */ ],
    uniswapV3: [ /* ABI for Uniswap V3 Factory */ ],
    sushiSwap: [ /* ABI for SushiSwap Factory */ ],
...
function analyzeData(data) {
    ...
    data.forEach(pairData => {
        const { uniswapV2Price, uniswapV3Price, sushiSwapPrice, oneinchPrice, volume, token0, token1 } = pairData;
